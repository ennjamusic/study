        ...
        <tr>
            ...
            <td>
                <select name="user[role]">
                    <option value="1" <?=($arrResult["role"]==USER_ROLE_ADMIN)?"selected":""?>><?=CApp::getTranslate("admin")?></option>
                    <option value="0"  <?=($arrResult["role"]==USER_ROLE_GUEST)?"selected":""?>><?=CApp::getTranslate("user")?></option>
                </select>
            </td>
        </tr>
        <tr>
